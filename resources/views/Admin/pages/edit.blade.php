...
@section('content')
        ...
        <div class="card-body">
            <form action="{{route('pages.update', ['page' => $page->id])}}" method="POST" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control @error('title') is-invalid @enderror" value="{{$page->title}}" name="title">
                    </div>
                </div>
    ...
    <script>
        tinymce.init({
            ...
            toolbar: 'undo redo | formatselect | bold italic backcolor | alignleft aligncenter alignright alingjustify | table | link image | bullist numlist',
            content_css: [
